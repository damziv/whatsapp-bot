        ...
        <div className="rounded-2xl border border-black/5 bg-white p-6 shadow-card backdrop-blur dark:border-white/10 dark:bg-white/5">
          {sent ? (
            <div className="space-y-2 text-center" aria-live="polite">
              ...
              {t('checkEmailBody', { email: emailNorm })}
              </p>

              {secondsLeft > 0 ? (
                <p className="text-xs text-neutral-500 dark:text-neutral-400">
                  {t('requestNewLinkIn', { seconds: secondsLeft })}
                </p>
              ) : (
                <p className="text-xs text-neutral-500 dark:text-neutral-400">
                  {t('notReceived')}
            ...
            <form onSubmit={onSubmit} className="grid gap-3">
              ...
              >
                {loading ? t('sending') : cooldownActive ? t('tryAgainIn', { seconds: secondsLeft }) : t('sendMagicLink')}
              </button>
